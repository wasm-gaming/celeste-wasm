...
import { DEFLATED, STORED, ZipReader } from '../dist/celeste/celeste.zip.js';

// --------------------------------------------------------------- a fixture --
//
// Building the archives here rather than checking one in keeps the test honest
// about the format: every offset the reader follows is one this file wrote.
